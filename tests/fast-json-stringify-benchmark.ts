...
const benchmarks = [
  ...
  //      },
  //      lastName: {
  //        type: ['string', 'null'] // no support for this
  //      },
  //      age: {
  ...
  //      }
  //    },
  //    required: ['firstName', 'lastName', 'age'] // these are ignored
  //  },
  //  input: { firstName: 'Max', lastName: 'Power', age: 22 }
  //},
  //
  // No support for "const" properties
  //{
...
async function runBenchmark (benchmark: any) {
